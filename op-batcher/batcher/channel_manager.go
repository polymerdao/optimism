...
func (s *channelManager) AddL2Block(block eth.EthBlock) error {
	s.mu.Lock()
	defer s.mu.Unlock()
...
func l2BlockRefFromBlockAndL1Info(block eth.EthBlock, l1info derive.L1BlockInfo) eth.L2BlockRef {
